					...
					<!-- start content_slider -->
					     <div class="slider">
						  	 <div id="da-slider" class="da-slider">
								<div class="da-slide">
								  <div class="da-img"><img src="<?php echo base_url(); ?>assets/images/share-slide-pic.png" class="img-responsive" alt=" " /></div>
					...
					<p class="head-para">Mauris euismod ultrices nisl sit amet luctus. Donec volutpat arcu ullamcorper facilisis vulputate. Sed auctor pulvinar ornare. Donec gravida. </p>
					 <div class="slider">
						  	 <div id="da-slider1" class="da-slider1">
								<div class="da-slide">
								  <div class="da-img"><img src="<?php echo base_url(); ?>assets/images/brush.png" class="img-responsive" alt=" " /></div>
								  <div class="slide-text">
		...
		<div id="gall" class="gallery">
			...
			<div id="owl-demo3" class="owl-carousel owl-carousel2">
				                <div class="item">
				                	<img class="lazyOwl" data-src="<?php echo base_url(); ?>assets/images/g1.jpg" alt="Lazy Owl Image">
				                	<p class="img_slider"><span class="g-title">Mauris euismod ultrices </span> <a class="likes" href="#"><i class="fa fa-heart"> </i> 65 </a></p>
				                </div>
				                 <div class="item">
				                	<img class="lazyOwl" data-src="<?php echo base_url(); ?>assets/images/g2.jpg" alt="Lazy Owl Image">
				                	<p class="img_slider"><span class="g-title">Mauris euismod ultrices </span> <a class="likes" href="#"><i class="fa fa-heart"> </i> 65 </a></p>
				                </div>
				                 <div class="item">
				                	<img class="lazyOwl" data-src="<?php echo base_url(); ?>assets/images/g3.jpg" alt="Lazy Owl Image">
				                	<p class="img_slider"><span class="g-title">Mauris euismod ultrices </span> <a class="likes" href="#"><i class="fa fa-heart"> </i> 65 </a></p>
				                </div>
				                 <div class="item">
				                	<img class="lazyOwl" data-src="<?php echo base_url(); ?>assets/images/g4.jpg" alt="Lazy Owl Image">
				                	<p class="img_slider"><span class="g-title">Mauris euismod ultrices </span> <a class="likes" href="#"><i class="fa fa-heart"> </i> 65 </a></p>
				                </div>
				                 <div class="item">
				                	<img class="lazyOwl" data-src="<?php echo base_url(); ?>assets/images/g1.jpg" alt="Lazy Owl Image">
		...
		<div id="down" class="download">
			<div class="container">
				...
				<div class="col-md-7 download-right">
					<p>Pelayanannya <br />Sangat Bagus<br />Aplikasinya Memuaskan</p>
					<a href="#">~Presiden</a>
